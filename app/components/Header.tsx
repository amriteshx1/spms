...
export function Header() {
  return (
    <header className="sticky top-0 z-50 border-b border-gold/25 bg-ink pt-[env(safe-area-inset-top)]">
      <div className="mx-auto flex max-w-280 flex-col gap-3 px-5 py-3 sm:px-8 md:flex-row md:items-center md:gap-8 md:py-3.5">
        <div className="flex items-center justify-between gap-4 md:min-w-0 md:flex-1">
          ...
          >
            <Image
              ...
              priority
            />
            <span className="font-serif text-[1.2rem] font-semibold leading-none tracking-normal text-gold sm:text-[1.35rem]">
              {company.wordmark}
            </span>
            <span className="hidden font-stamp text-[11px] font-medium tracking-normal text-dust lg:inline">
              {company.descriptor}
            </span>
          </a>
        ...
        >
          <ul className="flex items-center gap-5 font-stamp text-[12px] font-medium uppercase tracking-normal text-dust sm:gap-7">
            {nav.map((item) => (
              <li key={item.href}>
          ...
          <div className="hidden items-center gap-2 md:flex">
            ...
            <a
              className="btn btn-secondary min-w-26"
